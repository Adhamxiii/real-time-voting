...
export default async function Home() {
  ...
  return (
    <section className="min-h-screen bg-grid-zinc-50">
      <MaxWidthWrapper className="relative pb-24 pt-10 sm:pb-32 lg:pt-24 xl:pt-32 lg:pb-32">
        ...
        <div className="px-6 lg:px-0 lg:pt-4">
          <div className="relative mx-auto text-center flex flex-col items-center">
            ...
            <div className="mt-12 flx flex-col sm:flex-row items-center sm:items-start gap-5">
